...
public final class top_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("    <script type=\"text/javascript\">\r\n");
      out.write("        var previousQuery = \"\";\r\n");
      out.write("        var instantSearchTimeout;\r\n");
      out.write("\r\n");
      out.write("        function showPage(url) {\r\n");
      out.write("            parent.frames.main.location.href = url;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function triggerInstantSearch(event) {\r\n");
      out.write("            if (event.keyCode == 27) { // Escape key\r\n");
      out.write("                $(\"#query\").blur();\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            if (instantSearchTimeout) {\r\n");
      out.write("                window.clearTimeout(instantSearchTimeout);\r\n");
      out.write("            }\r\n");
      out.write("            instantSearchTimeout = window.setTimeout(executeInstantSearch, 300);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function executeInstantSearch() {\r\n");
      out.write("            var query = $(\"#query\").val().trim();\r\n");
      out.write("            if (query.length > 1 && query != previousQuery) {\r\n");
      out.write("                previousQuery = query;\r\n");
      out.write("                document.searchForm.submit();\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function toggleSideBar(show) {\r\n");
      out.write("            $(\"#hide-side-bar\").toggle(show);\r\n");
      out.write("            $(\"#show-side-bar\").toggle(!show);\r\n");
      out.write("            parent.toggleSideBar(show);\r\n");
      out.write("            multiService.setShowSideBar(show);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function keyboardShortcut(action, param) {\r\n");
      out.write("            if (action == \"toggleSideBar\") {\r\n");
      out.write("                if ($(\"#show-side-bar\").is(\":visible\")) {\r\n");
      out.write("                    $(\"#show-side-bar\").click();\r\n");
      out.write("                } else if ($(\"#hide-side-bar\").is(\":visible\")) {\r\n");
      out.write("                    $(\"#hide-side-bar\").click();\r\n");
      out.write("                }\r\n");
      out.write("            } else if (action == \"showHome\") {\r\n");
      out.write("                showPage(\"home.view\");\r\n");
      out.write("            } else if (action == \"showIndex\") {\r\n");
      out.write("                showPage(param ? \"artists.view#\" + param : \"artists.view\");\r\n");
      out.write("            } else if (action == \"showPlaylists\") {\r\n");
      out.write("                showPage(\"playlists.view\");\r\n");
      out.write("            } else if (action == \"showPodcasts\") {\r\n");
      out.write("                showPage(\"podcastChannels.view\");\r\n");
      out.write("            } else if (action == \"showSettings\") {\r\n");
      out.write("                showPage(\"settings.view\");\r\n");
      out.write("            } else if (action == \"showInternetRadio\") {\r\n");
      out.write("                showPage(\"internetRadio.view\");\r\n");
      out.write("            } else if (action == \"showBookmarks\") {\r\n");
      out.write("                showPage(\"bookmarks.view\");\r\n");
      out.write("            } else if (action == \"showStarred\") {\r\n");
      out.write("                showPage(\"starred.view\");\r\n");
      out.write("            } else if (action == \"showMore\") {\r\n");
      out.write("                showPage(param ? \"more.view#\" + param : \"more.view\");\r\n");
      out.write("            } else if (action == \"showAbout\") {\r\n");
      out.write("                showPage(\"help.view\");\r\n");
      out.write("            } else if (action == \"search\") {\r\n");
      out.write("                $(\"#query\").focus().select();\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      out.write("<body class=\"bgcolor2 topframe\" style=\"margin:0; white-space:nowrap\">\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<form method=\"post\" action=\"search.view\" target=\"main\" name=\"searchForm\">\r\n");
      out.write("\r\n");
      out.write("    <div style=\"display:flex; align-items:center; text-align:center\">\r\n");
      out.write("        <span id=\"show-side-bar\" class=\"top-menu-item\" style=\"display:");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.showSideBar ? 'none' : 'inline'}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("; margin-right:1em\" onclick=\"toggleSideBar(true)\"><i class=\"fa fa-bars fa-lg icon\"></i>&nbsp;</span>\r\n");
      ...
      out.write("</span>-->\r\n");
      out.write("        <!--<span class=\"top-menu-item\" onclick=\"showPage('nowPlaying.view')\"><i class=\"fa fa-headphones fa-fw fa-lg icon\"></i>&nbsp;");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${nowPlaying}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("</span>-->\r\n");
      out.write("        <!--<span class=\"top-menu-item\" onclick=\"showPage('starred.view')\"><i class=\"fa fa-star fa-fw fa-lg icon\"></i>&nbsp;");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${starred}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("</span>-->\r\n");
      out.write("        <span class=\"top-menu-item\" id=\"go-playlist\" onclick=\"showPage('playlists.view')\"><i class=\"fa fa-music fa-fw fa-lg icon\"></i>&nbsp;");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${playlists}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("</span>\r\n");
      out.write("        <!--<span class=\"top-menu-item\" onclick=\"showPage('podcastChannels.view')\"><i class=\"fa fa-rss fa-lg icon\"></i>&nbsp;");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${podcast}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("</span>-->\r\n");
      out.write("\r\n");
      out.write("        <span style=\"flex-grow:8\"></span>\r\n");
      out.write("\r\n");
      out.write("        <input type=\"text\" name=\"query\" id=\"query\" size=\"20\" placeholder=\"");
      ...
      out.write("\" onclick=\"select();\" onkeyup=\"triggerInstantSearch(event);\"\r\n");
      out.write("               style=\"flex-grow:8; margin-left:1em;margin-right:0.5em\">\r\n");
      out.write("        <span style=\"margin-right:1em\"><i class=\"fa fa-search icon clickable\" onclick=\"document.searchForm.submit()\"></i></span>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_fmt_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_0.setKey("top.home");
    _jspx_th_fmt_message_0.setVar("home");
  ...
  private boolean _jspx_meth_fmt_message_1(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:message
    org.apache.taglibs.standard.tag.rt.fmt.MessageTag _jspx_th_fmt_message_1 = (org.apache.taglibs.standard.tag.rt.fmt.MessageTag) _jspx_tagPool_fmt_message_var_key_nobody.get(org.apache.taglibs.standard.tag.rt.fmt.MessageTag.class);
    _jspx_th_fmt_message_1.setPageContext(_jspx_page_context);
    _jspx_th_fmt_message_1.setParent(null);
    _jspx_th_fmt_message_1.setKey("top.artists");
    _jspx_th_fmt_message_1.setVar("artists");
  ...
  private boolean _jspx_meth_fmt_message_2(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_2.setKey("top.now_playing");
    _jspx_th_fmt_message_2.setVar("nowPlaying");
  ...
  private boolean _jspx_meth_fmt_message_3(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_3.setKey("top.starred");
    _jspx_th_fmt_message_3.setVar("starred");
  ...
  private boolean _jspx_meth_fmt_message_4(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_4.setKey("left.playlists");
    _jspx_th_fmt_message_4.setVar("playlists");
  ...
  private boolean _jspx_meth_fmt_message_5(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_5.setKey("top.podcast");
    _jspx_th_fmt_message_5.setVar("podcast");
  ...
  private boolean _jspx_meth_fmt_message_6(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_6.setKey("top.help");
    _jspx_th_fmt_message_6.setVar("help");
  ...
  private boolean _jspx_meth_fmt_message_7(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_7.setKey("top.search");
    _jspx_th_fmt_message_7.setVar("search");
