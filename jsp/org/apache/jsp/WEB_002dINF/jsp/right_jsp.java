...
public final class right_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <script type=\"text/javascript\">\r\n");
      out.write("\r\n");
      out.write("        var chatRevision = 0;\r\n");
      out.write("\r\n");
      out.write("        function init() {\r\n");
      out.write("            dwr.engine.setErrorHandler(null);\r\n");
      out.write("\r\n");
      out.write("            startGetScanningStatusTimer();\r\n");
      out.write("\r\n");
      out.write("            ");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function startGetNowPlayingTimer() {\r\n");
      out.write("            nowPlayingService.getNowPlaying(getNowPlayingCallback);\r\n");
      out.write("            setTimeout(\"startGetNowPlayingTimer()\", 10000);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function getNowPlayingCallback(nowPlaying) {\r\n");
      out.write("            $(\"#now-playing-header\").toggle(nowPlaying.length > 0);\r\n");
      out.write("            var container = $(\"#now-playing-container\");\r\n");
      out.write("            container.empty();\r\n");
      out.write("\r\n");
      out.write("            for (var i = 0; i < nowPlaying.length; i++) {\r\n");
      out.write("                var entry = nowPlaying[i];\r\n");
      out.write("                var clone = $(\".now-playing-pattern\").clone();\r\n");
      out.write("                clone.removeClass(\"now-playing-pattern\");\r\n");
      out.write("\r\n");
      out.write("                var user = clone.find(\".now-playing-user\");\r\n");
      out.write("                var avatar = clone.find(\".now-playing-avatar\");\r\n");
      out.write("                var title = clone.find(\".now-playing-title\");\r\n");
      out.write("                var artist = clone.find(\".now-playing-artist\");\r\n");
      out.write("                var lyrics = clone.find(\".now-playing-lyrics\");\r\n");
      out.write("                var lyricsContainer = clone.find(\".now-playing-lyrics-container\");\r\n");
      out.write("                var coverart = clone.find(\".now-playing-coverart\");\r\n");
      out.write("                var albumlink = clone.find(\".now-playing-album-link\");\r\n");
      out.write("                var when = clone.find(\".now-playing-when\");\r\n");
      out.write("\r\n");
      out.write("                user.text(entry.username);\r\n");
      out.write("                title.text(entry.title);\r\n");
      out.write("                artist.text(entry.artist ? entry.artist : \"\");\r\n");
      out.write("                lyrics.attr(\"href\", entry.lyricsUrl);\r\n");
      out.write("                coverart.attr(\"src\", entry.coverArtUrl);\r\n");
      out.write("                albumlink.attr(\"href\", entry.albumUrl);\r\n");
      out.write("                lyricsContainer.toggle(entry.lyricsUrl != null);\r\n");
      out.write("\r\n");
      out.write("                if (entry.avatarUrl) {\r\n");
      out.write("                    avatar.attr(\"src\", entry.avatarUrl);\r\n");
      out.write("                } else {\r\n");
      out.write("                    avatar.hide();\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                var minutesAgo = entry.minutesAgo;\r\n");
      out.write("                if (minutesAgo > 4) {\r\n");
      out.write("                    when.text(minutesAgo + \" ");
      ...
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                clone.show();\r\n");
      out.write("                container.append(clone);\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function startGetMessagesTimer() {\r\n");
      out.write("            chatService.getMessages(chatRevision, getMessagesCallback);\r\n");
      out.write("            setTimeout(\"startGetMessagesTimer()\", 10000);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function addMessage() {\r\n");
      out.write("            chatService.addMessage($(\"#message\").val(), getMessagesCallback);\r\n");
      out.write("            $(\"#message\").val(null);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function clearMessages() {\r\n");
      out.write("            chatService.clearMessages(getMessagesCallback);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function getMessagesCallback(messages) {\r\n");
      out.write("\r\n");
      out.write("            if (messages == null) {\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            chatRevision = messages.revision;\r\n");
      out.write("\r\n");
      out.write("            // Delete all the rows except for the \"pattern\" row\r\n");
      out.write("            dwr.util.removeAllRows(\"chatlog\", { filter:function(div) {\r\n");
      out.write("                return (div.id != \"pattern\");\r\n");
      out.write("            }});\r\n");
      out.write("\r\n");
      out.write("            // Create a new set cloned from the pattern row\r\n");
      out.write("            for (var i = 0; i < messages.messages.length; i++) {\r\n");
      out.write("                var message = messages.messages[i];\r\n");
      out.write("                var id = i + 1;\r\n");
      out.write("                dwr.util.cloneNode(\"pattern\", { idSuffix:id });\r\n");
      out.write("                $(\"#user\" + id).text(message.username);\r\n");
      out.write("                $(\"#date\" + id).text(\" [\" + formatDate(message.date) + \"]\");\r\n");
      out.write("                $(\"#content\" + id).text(message.content);\r\n");
      out.write("                $(\"#pattern\" + id).show();\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            var clearDiv = $(\"#clearDiv\");\r\n");
      out.write("            if (clearDiv) {\r\n");
      out.write("                if (messages.messages.length == 0) {\r\n");
      out.write("                    clearDiv.hide();\r\n");
      out.write("                } else {\r\n");
      out.write("                    clearDiv.show();\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("            var result = hours < 10 ? \"0\" : \"\";\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function startGetScanningStatusTimer() {\r\n");
      out.write("            nowPlayingService.getScanningStatus(getScanningStatusCallback);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function getScanningStatusCallback(scanInfo) {\r\n");
      out.write("            $(\"#scanCount\").text(scanInfo.count);\r\n");
      out.write("            if (scanInfo.scanning) {\r\n");
      out.write("                $(\"#scanningStatus\").show();\r\n");
      out.write("                setTimeout(\"startGetScanningStatusTimer()\", 1000);\r\n");
      out.write("            } else {\r\n");
      out.write("                $(\"#scanningStatus\").hide();\r\n");
      out.write("                setTimeout(\"startGetScanningStatusTimer()\", 15000);\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
      out.write("<body class=\"bgcolor1 rightframe\" style=\"padding-top:2em\" onload=\"init()\">\r\n");
      out.write("<!--\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div id=\"scanningStatus\" style=\"display: none;\" class=\"warning\">\r\n");
      out.write("    <i class=\"fa fa-refresh fa-spin\"></i>&nbsp;&nbsp;");
      if (_jspx_meth_fmt_message_4(_jspx_page_context))
        return;
      out.write(" <span id=\"scanCount\"></span>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div class=\"now-playing-pattern\" style=\"display:none; margin-top:1.5em\">\r\n");
      out.write("    <div class=\"ellipsis\" style=\"margin-bottom:0.5em\">\r\n");
      out.write("        <img class=\"now-playing-avatar\" style=\"padding-right:5px;width:30px;height:30px\">\r\n");
      out.write("        <b><span class=\"now-playing-user ellipsis\"></span></b>\r\n");
      out.write("    </div>\r\n");
      out.write("    <div class=\"ellipsis\" style=\"display:flex\">\r\n");
      out.write("        <div class=\"ellipsis\" style=\"flex-grow:1\">\r\n");
      out.write("            <div class=\"ellipsis\"><a class=\"now-playing-album-link\" target=\"main\"><b><span class=\"now-playing-title\"></span></b></a></div>\r\n");
      out.write("            <div class=\"now-playing-artist ellipsis\"></div>\r\n");
      out.write("            <div class=\"now-playing-lyrics-container\" style=\"margin-top:0.5em\">\r\n");
      out.write("                <i class='fa fa-microphone icon'></i>&nbsp;&nbsp;<a class=\"now-playing-lyrics clickable\" onclick=\"return popupSize(this, 'lyrics', 500, 550)\">");
      if (_jspx_meth_fmt_message_5(_jspx_page_context))
        return;
      out.write("</a>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"now-playing-when\" style=\"margin-top:0.5em\"></div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <a class=\"now-playing-album-link\" target=\"main\"><img class=\"now-playing-coverart\" style=\"height:60px; width:60px; object-fit:cover; object-position:center; margin-left:0.4em\"></a>\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<h2 id=\"now-playing-header\" style=\"display:none\">");
      if (_jspx_meth_fmt_message_6(_jspx_page_context))
        return;
      out.write("</h2>\r\n");
      out.write("\r\n");
      out.write("<div id=\"now-playing-container\" class=\"detail\">\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_url_13(PageContext _jspx_page_context)
    ...
    _jspx_th_c_url_13.setValue("/dwr/util.js");
  ...
  private boolean _jspx_meth_c_url_14(PageContext _jspx_page_context)
    ...
    _jspx_th_c_url_14.setValue("/dwr/interface/chatService.js");
  ...
  private boolean _jspx_meth_c_url_16(PageContext _jspx_page_context)
    ...
    _jspx_th_c_url_16.setValue("/script/scripts-2.0.js");
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.showChat}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("            chatService.addMessage(null);\r\n");
        out.write("            ");
  ...
  private boolean _jspx_meth_c_if_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.showNowPlaying}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_1 = _jspx_th_c_if_1.doStartTag();
    if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("            startGetNowPlayingTimer();\r\n");
        out.write("            ");
  ...
  private boolean _jspx_meth_c_if_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.showChat}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_2 = _jspx_th_c_if_2.doStartTag();
    if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("            startGetMessagesTimer();\r\n");
        out.write("            ");
  ...
  private boolean _jspx_meth_fmt_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_0.setKey("main.minutesago");
  ...
  private boolean _jspx_meth_c_if_3(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not model.licenseInfo.licenseValid}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_3 = _jspx_th_c_if_3.doStartTag();
    if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("    <div class=\"detail\" style=\"text-align: center;padding-bottom: 1em\">\r\n");
        out.write("\r\n");
        out.write("        <i class=\"fa fa-trophy fa-lg icon\"></i>&nbsp;&nbsp;<a href=\"premiumSettings.view\" target=\"main\">");
        if (_jspx_meth_fmt_message_1(_jspx_th_c_if_3, _jspx_page_context))
          return true;
        out.write("</a>\r\n");
        out.write("        ");
  ...
  private boolean _jspx_meth_fmt_message_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:message
    ...
    _jspx_th_fmt_message_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_3);
    _jspx_th_fmt_message_1.setKey("top.getpremium");
  ...
  private boolean _jspx_meth_c_if_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.licenseInfo.trialDaysLeft gt 0}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_4 = _jspx_th_c_if_4.doStartTag();
    if (_jspx_eval_c_if_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("            <br>\r\n");
        out.write("            <a href=\"premiumSettings.view\" target=\"main\">");
        if (_jspx_meth_fmt_message_2(_jspx_th_c_if_4, _jspx_page_context))
          return true;
        out.write("</a>\r\n");
        out.write("        ");
  ...
  private boolean _jspx_meth_fmt_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_4, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:message
    ...
    _jspx_th_fmt_message_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_4);
    _jspx_th_fmt_message_2.setKey("top.trialdaysleft");
  ...
  private boolean _jspx_meth_fmt_param_0(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_message_2, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_param_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.licenseInfo.trialDaysLeft}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_if_5(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_5.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.newVersionAvailable}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_5 = _jspx_th_c_if_5.doStartTag();
    if (_jspx_eval_c_if_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("    <div class=\"warning\" style=\"padding-bottom: 1em\">\r\n");
        out.write("        ");
        if (_jspx_meth_fmt_message_3(_jspx_th_c_if_5, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("    </div>\r\n");
  ...
  private boolean _jspx_meth_fmt_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_5, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:message
    ...
    _jspx_th_fmt_message_3.setKey("top.upgrade");
    ...
    if (_jspx_eval_fmt_message_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        if (_jspx_meth_fmt_param_1(_jspx_th_fmt_message_3, _jspx_page_context))
          return true;
        if (_jspx_meth_fmt_param_2(_jspx_th_fmt_message_3, _jspx_page_context))
          return true;
  ...
  private boolean _jspx_meth_fmt_param_1(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_message_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:param
    ...
    _jspx_th_fmt_param_1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.brand}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_fmt_param_2(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_message_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  fmt:param
    ...
    _jspx_th_fmt_param_2.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.latestVersion}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_fmt_message_4(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_4.setKey("main.scanning");
  ...
  private boolean _jspx_meth_fmt_message_5(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_5.setKey("main.lyrics");
  ...
  private boolean _jspx_meth_fmt_message_6(PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_6.setKey("main.nowplaying");
  ...
  private boolean _jspx_meth_c_if_6(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_6.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.showChat}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_6 = _jspx_th_c_if_6.doStartTag();
    if (_jspx_eval_c_if_6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("    <h2 style=\"padding-top:1.5em\"><i class=\"fa fa-comment-o fa-lg fa-fw icon\"></i>&nbsp;");
        if (_jspx_meth_fmt_message_7(_jspx_th_c_if_6, _jspx_page_context))
          return true;
        out.write("</h2>\r\n");
        out.write("    <div style=\"padding-top:0.3em;padding-bottom:0.3em\">\r\n");
        out.write("        <input type=\"text\" id=\"message\" placeholder=\"");
        if (_jspx_meth_fmt_message_8(_jspx_th_c_if_6, _jspx_page_context))
          return true;
        out.write("\" style=\"width:100%\" onkeypress=\"dwr.util.onReturn(event, addMessage)\"/>\r\n");
        out.write("    </div>\r\n");
        out.write("\r\n");
        out.write("    <table>\r\n");
        out.write("        <tbody id=\"chatlog\">\r\n");
        out.write("        <tr id=\"pattern\" style=\"display:none;margin:0;padding:0 0 0.15em 0;border:0\"><td>\r\n");
        out.write("            <span id=\"user\" class=\"detail\" style=\"font-weight:bold\"></span>&nbsp;<span id=\"date\" class=\"detail\"></span> <span id=\"content\"></span></td>\r\n");
        out.write("        </tr>\r\n");
        out.write("        </tbody>\r\n");
        out.write("    </table>\r\n");
        out.write("\r\n");
  ...
  private boolean _jspx_meth_fmt_message_7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_6, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_7.setKey("main.chat");
  ...
  private boolean _jspx_meth_fmt_message_8(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_6, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_8.setKey("main.message");
  ...
  private boolean _jspx_meth_c_if_7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_6, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_7.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${model.user.adminRole}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_7 = _jspx_th_c_if_7.doStartTag();
    if (_jspx_eval_c_if_7 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("        <div id=\"clearDiv\" style=\"display:none;\"><i class=\"fa fa-remove fa-lg fa-fw icon\"></i>&nbsp;<a href=\"javascript:clearMessages()\">");
  ...
  private boolean _jspx_meth_fmt_message_9(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_7, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_9.setKey("main.clearchat");
