...
<form:form method="post" action="personalSettings.view" commandName="command">
    ...
    <table class="indent">
        <tr>
            <th style="padding:0 0.5em 0.5em 0;"><fmt:message key="personalsettings.display"/></th>
            <th style="padding:0 0.5em 0.5em 0.5em;" class="center"><fmt:message key="personalsettings.browse"/></th>
            <th style="padding:0 0 0.5em 0.5em;" class="center"><fmt:message key="personalsettings.playlist"/></th>
            <th style="padding:0 0 0.5em 0.5em; font-size: inherit;">
