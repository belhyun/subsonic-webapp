...
<form action="#" onsubmit="search();return false;">
    <table>
        <tr>
            ...
            <td style="padding-left:0.50em"><input id="artist" type="text" size="40" value="${fn:escapeXml(model.artist)}" tabindex="1"/></td>
        ...
        <tr>
            ...
            <td style="padding-left:0.50em"><input id="song" type="text" size="40" value="${fn:escapeXml(model.song)}" tabindex="2"/></td>
